...
fun SportsAppBar(
    ...
    val isShowingBackButtonAndInfo : Boolean = windowSize != WindowWidthSizeClass.Expanded && !isShowingListPage
    TopAppBar(
        title = {
            Text(
                text =
                if (isShowingBackButtonAndInfo) {
        ...
        navigationIcon = if (isShowingBackButtonAndInfo) {
            {
